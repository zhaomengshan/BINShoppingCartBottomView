...
- (BOOL)isInvalidData{
    ...
    if ([self isKindOfClass:[NSString class]]){
        ...
        selfString = (NSString *)[NSString stringDeleteWhiteSpace:selfString];
        if ([selfString isEqualToString:@""] || [selfString containsString:@"null"]) {
            return YES;
            
        }
    }else{
        NSAssert([self isKindOfClass:[NSString class]], @"请检查数据类型");
